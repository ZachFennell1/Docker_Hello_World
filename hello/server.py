...
def dns_broadcast(ipaddr, port):
    ...
    while True:
        try:
            ...
            continue
        break
    sock.sendall(b"Store Hello " + ipaddr.encode() + b" " + str(port).encode())
...
# Driver of the hello service sets it's port, calls the broadcast to the DNS server, and launches the service
